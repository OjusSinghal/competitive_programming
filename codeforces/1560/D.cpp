...
int main()
{
    ...
    vector<string> twos(63);
    REP(i, 0, 63) { twos[i] = to_string(arr[i]); }
    ...
    while (t--)
    {
        ...
        REP(i, 0, 63)
        {
            ...
            {
                // cout << "here" << endl;
                // cout << idx << " " << (int)com.length() << endl;
                steps += (int)com.length() - idx;
            }
            else
            {
                steps += (int)s.length() - j;
            }

            // cout << "steps for " << com << ": " << steps << endl;
